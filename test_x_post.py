#!/usr/bin/env python3
"""
Test script for X posting with image generation.
...
def test_x_post():
    ...
    if not Config.X_API_KEY:
        ...
        print("This test requires X_API_KEY, X_API_SECRET, X_ACCESS_TOKEN,")
        print("X_ACCESS_TOKEN_SECRET, and X_BEARER_TOKEN to be set.")
        sys.exit(1)
    ...
    # Step 2: Enhance for X
    print("Step 2: Optimizing message for X (Twitter)...")
    try:
    ...
    # Step 4: Post to X
    print("Step 4: Posting to X (Twitter)...")
    try:
        result = x_poster.post(enhanced_message, image_url=image_url)
